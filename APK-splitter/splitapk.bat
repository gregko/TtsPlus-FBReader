...
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore d:\users\greg\.android\Hyperionics.keystore -storepass HyperDroidek %apkfile%_armeabi.apk hyperionics
...
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore d:\users\greg\.android\Hyperionics.keystore -storepass HyperDroidek %apkfile%_armeabi-v7a.apk hyperionics
...
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore d:\users\greg\.android\Hyperionics.keystore -storepass HyperDroidek %apkfile%_x86.apk hyperionics
...
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore d:\users\greg\.android\Hyperionics.keystore -storepass HyperDroidek %apkfile%_mips.apk hyperionics
...
jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore d:\users\greg\.android\Hyperionics.keystore -storepass HyperDroidek %apkfile%.apk hyperionics
