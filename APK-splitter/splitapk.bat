...
copy ..\build\outputs\apk\%apkfile%-release.apk .\%apkfile%.apk
...
jarsigner -sigalg SHA1withRSA -digestalg SHA1 -keystore \users\greg\.android\Hyperionics.keystore -storepass HyperDroidek %apkfile%_armeabi.apk hyperionics
...
jarsigner -sigalg SHA1withRSA -digestalg SHA1 -keystore \users\greg\.android\Hyperionics.keystore -storepass HyperDroidek %apkfile%_mips.apk hyperionics
